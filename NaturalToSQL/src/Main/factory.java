...
public class Factory {
    ...
    public String getPrompt( )  {
        ...
        ChatLanguageModel model = LocalAiChatModel.builder()
                ...
                .temperature(0.9)
                .build(); //Define o servidor, qualidade da resposta e nome do modelo

        String languageSql = model.generate(this.getContent()); //Envia os dados do usuário e o esquema do banco de dados para gerar o SQL.
        return languageSql; //Retorna o SQL para o usuário
    }
